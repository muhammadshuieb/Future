-- Future Radius: official FreeRADIUS rlm_sql MySQL schema (Debian freeradius-mysql package).
-- CREATE TABLE IF NOT EXISTS — safe after DMA dump; fills gaps when dma-radius-dump.sql is placeholder-only.
SET NAMES utf8mb4;
